...
private dialog : MatDialogRef<DetailsComponent>,
  ...
  public approveRequest(id:any):void {
    this.requestService.setApprovedStatus(id, this.requestDetails).subscribe((response:any) => {
      this.requestDetails = response;
  ...
  public forwardRequest(id:any):void {
    this.requestService.setForwardedStatus(id, this.requestDetails).subscribe((response:any) => {
      this.requestDetails = response;
      this.toastrService.success('Request Forwarded');
    });
  }
}
